...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    include 'php/dbhandler.php';
      if (isset($_POST['submit'],$_POST['ID'],$_POST['sID'])) {
        $answers = "";
        $flag = true;
        ...
        if ($flag) {
          $sql2 = "UPDATE survey_answers SET is_open = 0, answers = '$answers' WHERE ID = $_POST[ID]";
          $result2 = mysqli_query($con,$sql2);
          $sql3 = "UPDATE survey SET replies = replies + 1 WHERE ID = $_POST[sID]";
